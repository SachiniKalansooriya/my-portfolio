      ...
      <div className="container relative z-10 px-6 py-12 mx-auto font-sans transition-all duration-500 ease-in-out sm:px-8 md:px-12 lg:px-24 xl:px-32 animate-fade-in">
        ...
        <section id="skills" className="min-h-screen py-16">
          ...
          <div className="mt-16 mb-16">
            <div className="mb-12 text-center">
              <h3 className="mb-4 text-3xl font-bold text-transparent lg:text-4xl bg-gradient-to-r from-purple-400 to-purple-500 bg-clip-text font-title">
                Soft Skills
              </h3>
              <p className="text-purple-300 font-satisfy">Personal qualities and collaborative abilities</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div className="relative z-10 space-y-4">
                  <div className="text-center">
                    <div className="flex items-center justify-center w-16 h-16 p-4 mx-auto mb-4 rounded-full bg-purple-500/20">
                      <svg className="w-8 h-8 text-purplr-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                   ...
                   <h4 className="mb-2 text-xl font-bold text-white">
                    ...
                    <p className="text-sm leading-relaxed text-gray-300">
                      Analytical thinking and creative approach to finding efficient solutions for complex technical challenges.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* Team Work */}
              <div className="relative p-6 transition-all duration-500 border shadow-xl group bg-white/5 border-white/10 rounded-3xl backdrop-blur-xl hover:bg-white/8 hover:border-blue-500/30 hover:shadow-blue-500/10">
                <div className="absolute inset-0 transition-opacity duration-500 opacity-0 rounded-3xl bg-gradient-to-br from-blue-500/5 via-transparent to-cyan-600/5 group-hover:opacity-100"></div>
                <div className="relative z-10 space-y-4">
                  <div className="text-center">
                    <div className="flex items-center justify-center w-16 h-16 p-4 mx-auto mb-4 rounded-full bg-blue-500/20">
                    ...
                    <p className="text-sm leading-relaxed text-gray-300">
                      Collaborative spirit with excellent communication skills, thriving in dynamic team environments.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* Creativity */}
              <div className="relative p-6 transition-all duration-500 border shadow-xl group bg-white/5 border-white/10 rounded-3xl backdrop-blur-xl hover:bg-white/8 hover:border-purple-500/30 hover:shadow-purple-500/10">
                <div className="absolute inset-0 transition-opacity duration-500 opacity-0 rounded-3xl bg-gradient-to-br from-purple-500/5 via-transparent to-pink-600/5 group-hover:opacity-100"></div>
                <div className="relative z-10 space-y-4">
                  <div className="text-center">
                    <div className="flex items-center justify-center w-16 h-16 p-4 mx-auto mb-4 rounded-full bg-purple-500/20">
                    ...
                    <p className="text-sm leading-relaxed text-gray-300">
                      Innovative thinking with artistic flair, bringing fresh perspectives to design and development projects.
                    </p>
                  </div>
                </div>
              </div>
