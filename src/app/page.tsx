  ...
  <section className="grid grid-cols-1 lg:grid-cols-2 items-start gap-8 pt-6 pb-12">
          ...
          <div className="space-y-6 max-w-xl">
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <a className="w-9 h-9 rounded-full border border-pink-500 flex items-center justify-center text-pink-400 hover:bg-pink-500/20" href="https://www.linkedin.com/in/sachini-kalansooriya/" aria-label="linkedin">in</a>
              <a className="w-9 h-9 rounded-full border border-pink-500 flex items-center justify-center text-pink-400 hover:bg-pink-500/20" href="https://github.com/SachiniKalansooriya" target="_blank" rel="noreferrer" aria-label="github">
